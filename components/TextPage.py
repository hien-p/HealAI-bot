...
def getSentiments(userText, type):
    if(type == 'Positive/Negative/Neutral-TextBlob'):
        ...
        if(status=="Positive"):
            image = Image.open('/home/harry/dev/project/polyhack/components/images/positive.PNG')
        elif(status == "Negative"):
            image = Image.open('/home/harry/dev/project/polyhack/components/images/negative.PNG')
        else:
            image = Image.open('/home/harry/dev/project/polyhack/components/images/neutral.PNG')
